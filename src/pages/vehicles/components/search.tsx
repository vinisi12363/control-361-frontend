...
export default function SearchList({
  ...
  if (isMobile) {
    return (
      <div className="flex w-full justify-center items-center px-0 py-4 border-b-2 border-zinc-800 rounded-md">
        <div className="flex flex-col w-full justify-between ">
          ...
          <div className="flex flex-row items-end relative left-2">
            <div className="flex flex-col pb-4">
              <h2 className="font-semibold text-xl mb-1">Listar:</h2>
